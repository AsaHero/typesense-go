...
[![GoReportCard Status](https://goreportcard.com/badge/github.com/AsaHero/typesense-go)](https://goreportcard.com/report/github.com/AsaHero/typesense-go)
[![Go Reference](https://pkg.go.dev/badge/github.com/AsaHero/typesense-go.svg)](https://pkg.go.dev/github.com/AsaHero/typesense-go)
[![GitHub release](https://img.shields.io/github/v/release/typesense/typesense-go)](https://github.com/AsaHero/typesense-go/releases/latest)
...
```
go get github.com/AsaHero/typesense-go
```
...
```go
import "github.com/AsaHero/typesense-go/typesense"
```
...
You can also find some examples in [integration tests](https://github.com/AsaHero/typesense-go/tree/master/typesense/test).
...
Bug reports and pull requests are welcome on GitHub at https://github.com/AsaHero/typesense-go.
